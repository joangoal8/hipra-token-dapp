        ...
        <div className="card mb-4" >
          ...
          <div className="card-body">
            ...
            <form className="mb-3" onSubmit={(event) => {
                ...
                if(sender) {
                    this.props.addNewResearcher(sender);
                } else {
                    window.alert('You need to fill the text field and select the step')
                }
              }}>
              <div>
                <label className="float-left"><b>Add researcher public address</b></label>
              </div>
              ...
              <button type="submit" className="btn hipra-btn-primary btn-block btn-lg">Add Researcher</button>
            </form>
          </div>
        </div>
      </div>
