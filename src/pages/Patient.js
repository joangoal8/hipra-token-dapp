        ...
        <div className="card mb-4" >
          ...
          <div className="card-body">
            ...
            <form className="mb-3" onSubmit={(event) => {
                ...
                if(sender) {
                    this.props.linkPatientSample(sender);
                } else {
                    window.alert('You need to fill the text field and select the step')
                }
              }}>
              <div>
                <label className="float-left"><b>Link your sample with your public key</b></label>
              </div>
              ...
              <button type="submit" className="btn hipra-btn-primary btn-block btn-lg">Link sample</button>
            </form>
          </div>
        </div>
      </div>
